...
const _readSettingsFile = (filename) => new Promise((resolve, reject) => {
...
const _parseJSON = (json) => new Promise((resolve, reject) => {
  try {
...
const _property = (property, object) => new Promise((resolve, reject) => {
  const sub = object[property];
  return sub ? resolve(sub) : reject(`Property "${property}" not found.`);
});

const loadLDAPSettings = (filename) => new Promise((resolve, reject) => {
