...
describe('MyActionItems Tab', function () {
    ...
    it("can filter my action items from all meeting series @watch", function () {
        ...
        var meetingName = aMeetingNameBase + '1';
        ...
        E2ETopics.addInfoItemToTopic({subject: 'action item  #1', itemType: "actionItem", responsible: "user1"}, 1);
        E2EMinutes.finalizeCurrentMinutes();

        E2EMinutes.addMinutesToMeetingSeries(aProjectName, meetingName);
        E2ETopics.addTopicToMinutes('topic #2');
        E2ETopics.addInfoItemToTopic({subject: 'action item  #2', itemType: "actionItem", responsible: "user1"}, 1);
        E2EMinutes.finalizeCurrentMinutes();
        ...
        E2ETopics.addInfoItemToTopic({subject: 'action item  #3', itemType: "actionItem", responsible: "user1"}, 1);
        E2EMinutes.finalizeCurrentMinutes();

        E2EMinutes.addMinutesToMeetingSeries(aProjectName, meetingName);
        E2ETopics.addTopicToMinutes('topic #4');
        E2ETopics.addInfoItemToTopic({subject: 'action item  #4', itemType: "actionItem", responsible: "user1"}, 1);
        E2EMinutes.finalizeCurrentMinutes();
