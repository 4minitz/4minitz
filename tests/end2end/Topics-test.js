...
describe('Topics', function () {
    ...
    beforeEach('goto start page and make sure test user is logged in', function () {
        const testContext = E2EApp.quickTestSetup();

        aProjectName = testContext.seriesTeam;
        aMeetingName = testContext.seriesName;

        E2EApp.gotoUrl(`minutesedit/${testContext.minutes}`);
    });
    ...
    it.skip('ensures invited user can not drag-n-drop topics', function () {
        ...
        browser.selectByValue(selector, 'Invited');
