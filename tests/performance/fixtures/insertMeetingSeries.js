...
let optionParser = require('node-getopt').create([
    ['m', 'mongourl=[ARG]', 'Mongo DB url (default: mongodb://localhost:3101/meteor)'],
    ['u', 'username=[ARG]', 'The username of the user who should be the owner of the created minutes (default: user1)'],
    ['', 'minutes-count=[ARG]', 'The number of minutes which should be created'],
    ['', 'topics-range=[ARG]', 'The range of topics each minutes should contain (e.g. 3-10)'],
    ['', 'items-range=[ARG]', 'The range of items each topic should contain (e.g. 1-8)'],
    ['', 'details-range=[ARG]', 'The range of sentences each detail should contain (e.g. 7-23)'],
