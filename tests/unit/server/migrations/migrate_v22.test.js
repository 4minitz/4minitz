...
const {
        MigrateV22
    } = proxyquire('../../../../server/migrations/migrate_v22', {
...
describe('Migrate Version 22', function() {
    ...
    describe('#up', function() {
        ...
        beforeEach(function() {
            ...
            const topicsOfFirstSeries = [ { _id: topic1, parentId: 'ms#01' }, { _id: topic2, parentId: 'ms#01' } ];
            const topicsOfAnotherSeries = [ { _id: topic3, parentId: 'ms#02' } ];
            TopicSchema.find.returns(topicsOfFirstSeries.concat(topicsOfAnotherSeries));
