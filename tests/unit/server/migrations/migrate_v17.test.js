...
describe('Migrate Version 17', function () {
    ...
    let firstMinutes, secondMinutes,
        ...
        itemFirstAndSecondMinutes, itemSecondMinutes;
    ...
    beforeEach(function () {
        ...
        topicSecondMinutes = {
            _id: 'AaBbCc03',
            infoItems: [JSON.parse(JSON.stringify(itemFirstAndSecondMinutes)), JSON.parse(JSON.stringify(itemSecondMinutes))]
        };
    ...
    describe('#up', function() {
        ...
        it('calls the update method of the topics collection for each different topic and sets the new fields', function() {
            ...
            itemFirstAndSecondMinutes.updatedAt = expectedDateForElementsCreatedInFirstMinutes;
            itemFirstAndSecondMinutes.details[0].createdAt = expectedDateForElementsCreatedInFirstMinutes;
            itemFirstAndSecondMinutes.details[0].updatedAt = expectedDateForElementsCreatedInFirstMinutes;
            ...
            expect(TopicSchema.update.calledWith(topicFirstMinutes._id, expectedUpdateParamFirstMinutes)).to.be.true;
            expect(TopicSchema.update.calledWith(topicFirstAndSecondMinutes._id, expectedUpdateParamFirstMinutesWithItems)).to.be.true;
        });
        ...
        it('sets the createdAt/updatedAt fields for all items of each topic in the topics collection', function() {
            ...
            expect(argsFirstCall[1].$set.infoItems[0].createdAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
        });
        ...
        it('sets the createdAt/updatedAt fields for all items of each topic in the topics collection', function() {
            ...
            expect(itemsOfFirstTopic[0].details[0].createdAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
            expect(itemsOfFirstTopic[0].details[0].updatedAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
        });
        ...
        it('updates each minutes and sets the createdAt/updatedAt fields for each topic', function() {
            ...
            expect(topcisFirstCall[0].createdAt.getTime()).to.equal(expectedDateForElementsCreatedInFirstMinutes.getTime());
            expect(topcisFirstCall[0].updatedAt.getTime()).to.equal(expectedDateForElementsCreatedInFirstMinutes.getTime());
            expect(topcisFirstCall[1].createdAt.getTime()).to.equal(expectedDateForElementsCreatedInFirstMinutes.getTime());
            expect(topcisFirstCall[1].updatedAt.getTime()).to.equal(expectedDateForElementsCreatedInFirstMinutes.getTime());

            const topcis2ndCall = argsSecondCall[1].$set.topics;
            expect(topcis2ndCall).to.have.length(2);
            expect(topcis2ndCall[0].createdAt.getTime()).to.equal(expectedDateForElementsCreatedInFirstMinutes.getTime());
            expect(topcis2ndCall[0].updatedAt.getTime()).to.equal(expectedDateForElementsCreatedInFirstMinutes.getTime());
            expect(topcis2ndCall[1].createdAt.getTime()).to.equal(expectedDateForElementsCreatedIn2ndMinutes.getTime());
            expect(topcis2ndCall[1].updatedAt.getTime()).to.equal(expectedDateForElementsCreatedIn2ndMinutes.getTime());
        });
        ...
        it('sets the createdAt/updatedAt field for all items of each topic in the minutes collection', function() {
            ...
            expect(topicsFirstCall[0].infoItems[0].createdAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
            expect(topicsFirstCall[0].infoItems[0].updatedAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);

            const topics2ndCall = argsSecondCall[1].$set.topics;
            expect(topics2ndCall[0].infoItems).to.have.length(1);
            expect(topics2ndCall[0].infoItems[0].createdAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
            expect(topics2ndCall[0].infoItems[0].updatedAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
            expect(topics2ndCall[1].infoItems).to.have.length(2);
            expect(topics2ndCall[1].infoItems[0].createdAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
            expect(topics2ndCall[1].infoItems[0].updatedAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
            expect(topics2ndCall[1].infoItems[1].createdAt).to.equal(expectedDateForElementsCreatedIn2ndMinutes);
            expect(topics2ndCall[1].infoItems[1].updatedAt).to.equal(expectedDateForElementsCreatedIn2ndMinutes);
        });
        ...
        it('sets the createdAt/updatedAt field for all details of the items of a topic in the minutes collection', function() {
            ...
            expect(itemsFirstCall[0].details[0].createdAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
            expect(itemsFirstCall[0].details[0].updatedAt).to.equal(expectedDateForElementsCreatedInFirstMinutes);
    ...
    describe('#down', function() {
        ...
        it('deletes createdAt/updatedAt fields of all documents stored in each minutes and updates them', function() {
            ...
            const topicContainsInvalidField = topic => topic.createdAt || topic.updatedAt;
