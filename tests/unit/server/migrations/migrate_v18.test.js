  ...
  describe("#up", () => {
    ...
    it("sets the createdAt/updatedAt fields for all items of each topic in the topics collection",
       () => {
         ...
         expect(argsFirstCall[1].$set.infoItems[0].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
       });
    ...
    it("sets the createdAt/updatedAt fields for all items of each topic in the topics collection",
       () => {
         ...
         expect(itemsOfFirstTopic[0].details[0].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(itemsOfFirstTopic[0].details[0].updatedAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
       });
    ...
    it("updates each minutes and sets the createdAt/updatedAt fields for each topic",
       () => {
         ...
         expect(topcisFirstCall[0].createdAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes.getTime(),
             );
         expect(topcisFirstCall[0].updatedAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes.getTime(),
             );
         expect(topcisFirstCall[1].createdAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes.getTime(),
             );
         expect(topcisFirstCall[1].updatedAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes.getTime(),
             );
         ...
         expect(topcis2ndCall[0].createdAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes.getTime(),
             );
         expect(topcis2ndCall[0].updatedAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes.getTime(),
             );
         expect(topcis2ndCall[1].createdAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedIn2ndMinutes.getTime(),
             );
         expect(topcis2ndCall[1].updatedAt.getTime())
             .to.equal(
                 expectedDateForElementsCreatedIn2ndMinutes.getTime(),
             );
       });
    ...
    it("sets the createdAt/updatedAt field for all items of each topic in the minutes collection",
       () => {
         ...
         expect(topicsFirstCall[0].infoItems[0].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(topicsFirstCall[0].infoItems[0].updatedAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         ...
         expect(topics2ndCall[0].infoItems[0].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(topics2ndCall[0].infoItems[0].updatedAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(topics2ndCall[1].infoItems).to.have.length(2);
         expect(topics2ndCall[1].infoItems[0].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(topics2ndCall[1].infoItems[0].updatedAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(topics2ndCall[1].infoItems[1].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedIn2ndMinutes,
             );
         expect(topics2ndCall[1].infoItems[1].updatedAt)
             .to.equal(
                 expectedDateForElementsCreatedIn2ndMinutes,
             );
       });
    ...
    it("sets the createdAt/updatedAt field for all details of the items of a topic in the minutes collection",
       () => {
         ...
         expect(itemsFirstCall[0].details[0].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(itemsFirstCall[0].details[0].updatedAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         ...
         expect(items2ndCall[0].details[0].createdAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
         expect(items2ndCall[0].details[0].updatedAt)
             .to.equal(
                 expectedDateForElementsCreatedInFirstMinutes,
             );
       });
