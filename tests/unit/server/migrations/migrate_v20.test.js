...
const {
    MigrateV20
} = proxyquire('../../../../server/migrations/migrate_v20', {
...
describe('Migrate Version 20', function () {
        ...
        firstFakeMinute = {
            ...
            topics: [{
                ...
                infoItems:[{
                    ...
                    _id: '#I02',
                    details: [{text: 'd2', createdInMinute: FIRST_MIN_ID}, {text:'d3', createdInMinute: FIRST_MIN_ID}]
                }]
            }, {
                _id: '#T02',
                infoItems:[{
    ...
    describe('#up', function () {
        ...
        // only checks minutes because topic collection will be overriden with next finalize anyways
