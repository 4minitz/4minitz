...
const {
    MinutesFinder
    } = proxyquire('../../../../imports/services/minutesFinder', {
...
describe('MinutesFinder', function() {
    ...
    const FakeMinutes = [{_id: '123'}, {_id: 'abc'}],
        EmptyMinutesCollection = {
            find: sinon.stub().returns([])
        },
        MinutesCollection = {
            find: sinon.stub().returns(FakeMinutes)
        };
    let MeetingSeries;
    ...
    const setupNonEmptySeries = function () {
        ...
        MeetingSeries = {
            minutes: FakeMinutes.map(m => m._id)
        };
    };
    ...
    describe('#allMinutesOfMeetingSeries', function () {
        ...
        it('returns all minutes up to the given limit', function () {
            ...
            const result = MinutesFinder.allMinutesOfMeetingSeries(MeetingSeries, limitedNumberOfMinutes);
        ...
        it('sorts the minutes ascending if the sortDescending parameter is given as false', function () {
            ...
            const result = MinutesFinder.allMinutesOfMeetingSeries(MeetingSeries, numberOfMinutes, sortDescending);
    ...
    describe('#secondLastMinutesOfMeetingSeries', function () {
        it('returns false for an empty series', function () {
            ...
            const result = MinutesFinder.secondLastMinutesOfMeetingSeries(MeetingSeries);
    ...
    describe('#previousMinutes', function () {
        it('returns false for empty series', function () {
            setupEmptySeries();
            const minutes = {
                parentMeetingSeries: _ => MeetingSeries
            };
