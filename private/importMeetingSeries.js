...
let ExpImpFileAttachments =
    require("../imports/server/exportimport/expImpFilesAttachments");
let ExpImpFileDocuments =
    require("../imports/server/exportimport/expImpFilesDocuments");
...
_connectMongo(mongoUrl)
    .then((db) => {
      return ExpImpSchema.preImportCheck(db, meetingseriesID,
                                         arg.options.force);
    })
