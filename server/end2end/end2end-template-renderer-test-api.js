...
if (Meteor.settings.isEnd2EndTest) {
    ...
    console.log('End2End helpers for the serve-templates-API are loaded on server-side!');
    ...
    Meteor.methods({
        'e2e-render-template'(template, data) {
            ...
            const date = new Date();
            const tmplRenderer = new TemplateRenderer(template, null,/* loadTmplFromAssets */ false);
